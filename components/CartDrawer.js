                  ...
                  <div>
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <button
                        ...
                        className="text-[#1E293B]/40 hover:text-rose-600 transition-all flex-shrink-0 cursor-pointer p-1"
                        title="Remove item"
                      >
                  ...
                  <div className="flex justify-between items-end mt-2">
                    ...
                    <div className="flex items-center gap-1.5 bg-white rounded-lg p-1 border border-[#1E293B]/10">
                      <button
                        ...
                        className="w-6 h-6 flex items-center justify-center rounded hover:bg-[#F8F9FA] text-[#1E293B] font-semibold text-xs transition-all cursor-pointer"
                      >
                        –
                      </button>
