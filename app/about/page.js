  ...
  return (
    <div className="min-h-screen bg-bg-brand text-text-brand antialiased selection:bg-[#3674B5] selection:text-white">
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-16 pt-6 md:pt-12 pb-16 md:pb-24 relative z-10 space-y-12 md:space-y-24">
        ...
        {/* Page Header */}
        <div className="text-center space-y-2 md:space-y-4 max-w-3xl mx-auto border-b border-[#1E293B]/10 pb-4 md:pb-8">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#3674B5]/10 border border-[#3674B5]/30">
            <span className="w-1 h-1 rounded-full bg-[#3674B5] animate-pulse" />
          ...
          <p className="text-xs sm:text-base font-semibold text-[#1E293B]/50 max-w-xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 md:space-y-6">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#3674B5]/10 border border-[#3674B5]/30">
              <Sparkles className="w-3 h-3 text-[#3674B5]" />
              <span className="text-[9px] md:text-[10px] font-extrabold text-[#3674B5] uppercase tracking-wider">
                Corporate Profile
              </span>
            </div>
            ...
            <p className="text-xs font-semibold text-[#1E293B]/50 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-4 md:space-y-6">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#3674B5]/10 border border-[#3674B5]/30">
              <span className="w-1 h-1 rounded-full bg-[#3674B5]" />
              <span className="text-[9px] md:text-[10px] font-extrabold text-[#3674B5] uppercase tracking-wider">
          ...
          <div className="lg:col-span-6 space-y-4 md:space-y-6 mt-6 lg:mt-0">
            ...
            <div className="space-y-3 pt-1">
              {pillars.map((pillar, idx) => (
                <div 
                  key={idx}
                  className="flex items-start gap-3 p-4 rounded-xl md:rounded-2xl bg-white border border-[#1E293B]/10 shadow-3xs"
                >
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl bg-[#F8F9FA] border border-[#1E293B]/5 flex items-center justify-center flex-shrink-0">
                    {pillar.icon}
                  </div>
        ...
        <div className="relative rounded-2xl md:rounded-[3rem] bg-[#3674B5] text-white p-6 md:p-12 overflow-hidden shadow-xl text-center space-y-4 md:space-y-6">
          ...
          <p className="text-[10px] sm:text-sm text-white/80 font-bold max-w-lg mx-auto uppercase tracking-wider">
